...
function histogram = lbp(varargin) % image,radius,neighbors,mapping,mode)
% Version 0.3.2
...
%             region_hist = hist(region_result(:),0:(bins-1)) * region_weights(i, j);
            region_hist = hist(region_result(:),0:(bins-1));
